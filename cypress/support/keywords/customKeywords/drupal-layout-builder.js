...
Cypress.Commands.add('addBlock', (blockType, sectionIndex, blockSettings = {}) => {
  ...
  cy.get(`#layout-builder-modal > div.block-categories.js-layout-builder-categories.glb-layout-builder-browser > details > div  >a `).contains(blockType).click();  // Select the block type
  if (blockSettings) {
