Feature: CKEditor Functionality
  ...
  Scenario: Validate Bold text content in CKEditor
    When I navigate to the CKEditor field in content "Testing Ck editor"
    And I change the text format to "Rich text"
  ...
  Scenario: Validate Bulleted list content in CKEditor
    When I navigate to '/admin/content'
    And I navigate to the CKEditor field in content "Testing Ck editor"
    And I change the text format to "Rich text"
  ...
  @smoke @regression @sanity
  Scenario: Validate Blockquote content in CKEditor
    When I navigate to the CKEditor field in content "Testing Ck editor"
    And I change the text format to "Rich text"
    And I apply formatting "blockquote" and type in "/htmlTestData/blockQuote.html" from fixture
    Then I save basic page "Testing Ck editor" and validate the content "/htmlTestData/blockQuote.html" format is 'blockquote'

  @smoke @regression @sanity
  Scenario: Validate Upload Image content in CKEditor
    When I navigate to the CKEditor field in content "Testing Ck editor"
    And I change the text format to "Rich text"
    And I apply formatting "image" and type in "https://uhg.lndo.site/sites/default/files/2024-11/uhg-press-release_28.jpg"
    Then I save basic page "Testing Ck editor" and validate the content "https://uhg.lndo.site/sites/default/files/2024-11/uhg-press-release_28.jpg" format is 'image'
  ...
  Scenario Outline: Validate the headings "<heading>" and paragraph in Ckeditor
    ...
    Examples:
      ...
      | Heading 1 | h1  | This is a heading 1 |
  ...
  @smoke @regression @sanity
  Scenario: Validate the insert table in Ckeditor
    When I navigate to the CKEditor field in content "Testing Ck editor"
    And I change the text format to "Rich text"
    And I insert a table with required columns and rows
    Then I should see the table with data in the frontend for "Testing Ck editor"
